...
#define SET__SELECT__LAYER__INDEX(__index__) TOOL::SetHigData(_selectIndex, __index__)
#define SET__SELECT__SPRITE__INDEX(__index__) TOOL::SetLowData(_selectIndex, __index__)
