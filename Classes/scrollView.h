...
const int WINDOW_WIDTH = 1136.0f;
const int WINDOW_HEIGHT = 640.0f;
...
public:
	...
	//virtual bool onDialogTouchBegan(Touch *pTouch,Event *pEvent);
	//virtual void onDialogTouchMoved(Touch *pTouch,Event *pEvent);
	//virtual void onDialogTouchEnded(Touch *pTouch,Event *pEvent);
